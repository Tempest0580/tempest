...
class seasons:
    def __init__(self):
        ...
        self.tvdb_key = 'N0E5RjBGNTdCNkU4MTMyRA=='
    ...
    def tvdb_list(self, tvshowtitle, year, imdb, tvdb, lang, limit=''):
        ...
        try:
            ...
            if not control.setting('show_specials'):
        ...
        for item in seasons:
            try:
                ...
                elif not control.setting('future_seasons'):
                    if int(re.sub('[^0-9]', '', str(premiered))) > int(re.sub('[^0-9]', '', str(self.today_date))): label = label2
        ...
        for item in episodes:
            try:
                ...
                elif not control.setting('future_episodes'):
    ...
    def episodeDirectory(self, items):
        ...
        for i in items:
            ...
            try:
                ...
                if control.setting('future_episodes') == 'true':
                    if self.episodes_colours == '0':
                        label2 = '[COLOR blue][I]%s[/I][/COLOR]' % label
                    elif self.episodes_colours == '1':
                        label2 = '[COLOR red][I]%s[/I][/COLOR]' % label
                    elif self.episodes_colours == '2':
                        label2 = '[COLOR yellow][I]%s[/I][/COLOR]' % label
                    elif self.episodes_colours == '3':
                        label2 = '[COLOR deeppink][I]%s[/I][/COLOR]' % label
                    elif self.episodes_colours == '4':
                        label2 = '[COLOR cyan][I]%s[/I][/COLOR]' % label
                    elif self.episodes_colours == '5':
                        label2 = '[COLOR lawngreen][I]%s[/I][/COLOR]' % label
                    elif self.episodes_colours == '6':
                        label2 = '[COLOR gold][I]%s[/I][/COLOR]' % label
                    elif self.episodes_colours == '7':
                        label2 = '[COLOR magenta][I]%s[/I][/COLOR]' % label
                    elif self.episodes_colours == '8':
                        label2 = '[COLOR yellowgreen][I]%s[/I][/COLOR]' % label
                    elif self.episodes_colours == '9':
                        label2 = '[COLOR nocolor][I]%s[/I][/COLOR]' % label
                if int(re.sub('[^0-9]', '', str(premiered))) > int(re.sub('[^0-9]', '', str(self.today_date))): label = label2
                else:
                    if int(re.sub('[^0-9]', '', str(premiered))) > int(re.sub('[^0-9]', '', str(self.today_date))): raise Exception()
