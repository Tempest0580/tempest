...
class navigator:
    ...
    def root(self):
        ...
        if traktIndicators == True and not control.setting('lists.widget') == '0':
    ...
    def tools(self):
        ...
        self.addDirectoryItem(32044, 'openSettings&query=1.0', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32045, 'openSettings&query=2.0', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32046, 'openSettings&query=3.1', 'tools.png', 'DefaultAddonProgram.png')
