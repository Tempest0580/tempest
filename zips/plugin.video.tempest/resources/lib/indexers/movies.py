...
class movies:
    def __init__(self):
        ...
        self.tm_art_link = 'http://api.themoviedb.org/3/movie/%s/images?api_key=%s&language=en-US&include_image_language=en,null' % ('%s', self.tm_user.decode('base64'))
        ...
        self.theaters_link = 'http://www.imdb.com/search/title?title_type=feature&num_votes=1000,&release_date=date[365],date[0]&primary_language=en&sort=release_date,desc&count=40&start=1'
    ...
    def worker(self, level=1):
        ...
        self.fanart_tv_headers = {'api-key': 'ZGIxMDYxOWM5N2FmODM4OTE2OTBmNGNmZDcyMDVkNjI='.decode('base64')}
