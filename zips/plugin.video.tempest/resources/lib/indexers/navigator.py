...
class navigator:
    ...
    def settings(self):
        ...
        self.addDirectoryItem(32045, 'openSettings&query=2.0', 'settings.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32046, 'openSettings&query=3.1', 'settings.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32048, 'openSettings&query=4.0', 'settings.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32047, 'openSettings&query=5.0', 'settings.png', 'DefaultAddonProgram.png')
