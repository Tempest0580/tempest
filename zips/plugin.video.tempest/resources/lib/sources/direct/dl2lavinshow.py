...
class source:
    def __init__(self):
        ...
        self.base_link = 'http://dl2.lavinmovie.net/series/'
        self.search_link = '%s/'
            ...
            for r in r:
                if '1080p x265' in r:
                    ...
                    for url in r:
                        ...
                        url = result2 + url
                        quality = source_utils.check_direct_url(url)
                        sources.append({'source': 'Direct', 'quality': 'SD', 'language': 'en', 'url': url, 'direct': True, 'debridonly': False})
            return sources
        except:
            return
